...
# Маршрут для чтения текста существующей заметки по ее ID
...
# Маршрут для получения информации о заметке по ее ID
...
# Маршрут для редактирования текста существующей заметки по ее ID
...
# Маршрут для удаления существующей заметки по ее ID
...
# Маршрут для получения списка всех заметок вместе с их ID
...
def list_of_notes(token: str = Depends(verification)):
    ...
    return ListOfNotes(notes=dict_ids)
